  ...
  const location=UseLocation();
    ...
    return(
        <div className="-mt-3.5  ">
           ...
           <div >
            <input type="text"  value={query} onChange={(e)=>debouncedSetQuery(e.target.value)} placeholder="  Search for the restaurant and food"
            
            className={theme=== "dark"? "bg-gray-900 text-gray-100 w-80 h-14 rounded-2xl  ml-12 flex justify-end items-center mt-2 mr-4" : "bg-white text-black w-80 h-14 rounded-2xl  ml-12 flex justify-end items-center mt-2 mr-4"}
            />
            ...
            <ul className="flex ml-1 mt-6 gap-12 font-bold">
                <li className="ml-4">
                    ...
                    <div className="flex">
                        ...
                        className="w-18 h-17  -mt-5 -mr-5  rounded-b-full rounded-r-full rounded-l-full rounded-t-full"
                        />
                ...
                <img src="data:image/png;base64,"
                    ...
                    className="w-10 h-10  -ml-4 -mt-2 rounded-b-full rounded-e-full rounded-l-full"
