  ...
  const {CartItems}=useCart();
    ...
    return(
        <div className="-mt-3.5 ">
            ...
            alt="oopsy"
            className=" ml-1  mt-0 w-20 rounded-bl-2xl hover:scale-95"

            /></button></Link>
            
            <div className="flex">
            <h1 className="ml-2 mt-7 text-1xl font-bold">HOME - </h1>
            <p className="mt-10 -ml-15 text-amber-600 font-extrabold">________</p>
            <p className="mt-7 ml-2 text-gray-500"> Cantt Road, Mohyal Nagar, Jaland...</p>
           ...
           <div >
            ...
            className="bg-gray-100 ml-5 w-80 h-14 rounded-2xl mt-3"
            />
            <img src="data:image/png;base64,"
              alt="oopsy" 
              className="w-6 h-5 ml-74 overflow-hidden object-cover -mt-9 rounded-xs rounded-b-full rounded-t-full bg-gray-600 "          
             />
            </div>
            ...
            <ul className="flex ml-1 mt-6 gap-12 font-bold">
                ...
                <li>
                    ...
                    />
                    <Link to="/Cart" className="hover:text-amber-600">Cart<div className="-mt-9 ml-5 overflow-hidden  bg-emerald-700 text-amber-50 w-7  h-7 p-1 rounded-full flex justify-center align-middle">{CartItems?.length}</div></Link></div>
                </li>
